...
export default function EventCalendar({ events, units, users }: EventCalendarProps) {
  ...
  const filteredEvents = events.filter(event => {
    ...
    if (filterOption === "specific" && selectedUnitIds.length > 0) {
      ...
      if (!selectedUnitIds.includes(eventUnitId) && 
    ...
    <Card className="w-full shadow-md">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <CardTitle className="text-lg md:text-xl">Training Calendar</CardTitle>
          
          <div className="flex gap-2">
            <Button 
              variant="outline" 
              size="sm"
              onClick={() => setActiveView(activeView === "month" ? "week" : "month")}
            >
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="parent">Parent Units Only</SelectItem>
