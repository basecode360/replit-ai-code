...
export default function EventCalendar({
  ...
  const filteredEvents = events.filter((event) => {
    ...
    if (searchQuery) {
      ...
      return (
        matchesTitle || matchesLocation || matchesUnit || matchesParticipants
      );
    }
            ...
            <Popover open={filterOpen} onOpenChange={setFilterOpen}>
              <PopoverTrigger asChild>
                <Button
                  ...
                  className={cn(
                    "gap-1",
                    (selectedUnitIds.length > 0 || searchQuery) &&
                ...
                <div className="grid gap-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Show events for specific units or find events by name,
                      location, or participating personnel.
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Find events by name, location, participating units, or
                      users
                    </p>
                  </div>
