import { FileText, Award, AlertTriangle, CheckCircle, Calendar, User } from "lucide-react";
    ...
    <div className="container py-6">
      ...
      <div className="flex flex-col space-y-6">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">
              Capture, analyze, and preserve training insights across your organization
            </p>
          </div>
        </div>
        ...
        <Tabs defaultValue="all" className="space-y-4">
          ...
          <TabsContent value="all" className="space-y-4 aar-list"> {/* This div is targeted by the tour highlight */}
          ...
          <TabsContent value="platoon" className="space-y-4">
            <div className="grid gap-6">
              {demoAARs.filter(aar => aar.eventId === 1).map((aar) => (
                <AARCard key={aar.id} aar={aar} />
              ))}
            </div>
          </TabsContent>
          ...
          <TabsContent value="squad" className="space-y-4">
            <div className="grid gap-6">
              {demoAARs.filter(aar => aar.eventId === 2).map((aar) => (
                <AARCard key={aar.id} aar={aar} />
              ))}
            </div>
          </TabsContent>
      ...
      <div className="mt-12">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              After Action Reviews capture critical insights that follow personnel throughout their career
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="border rounded-md p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  AARs are organized into "Sustain," "Improve," and "Action Items" categories, ensuring 
                  clear communication of what worked, what didn't, and what needs to change.
                </p>
              </div>
              ...
              <div className="border rounded-md p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  Unlike traditional systems where AARs are tied only to units, GreenBookAAR associates AARs
                  with both units AND individuals, preserving insights when personnel transfer.
                </p>
              </div>
              ...
              <div className="border rounded-md p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  When individuals transfer to new units, their AAR history follows them, allowing new
                  units to benefit from their experiences and preventing institutional knowledge loss.
                </p>
              </div>
            </div>
          </CardContent>
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <div className="flex items-start gap-2">
          ...
          <div>
            <div className="font-medium">{aar.author.rank} {aar.author.name}</div>
            <div className="text-xs text-muted-foreground">{aar.author.unitName}</div>
          </div>
        </div>
