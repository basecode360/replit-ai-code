...
const demoResponses: { [key: string]: string } = {
  "What are the most common issues in our squad movement techniques?": `Based on analysis of 28 recent AARs related to squad movement, the most common issues are:
...
The data suggests focusing training on consistent spacing drills, formation transition practice, and standardizing hand signal protocols across all squads.`,
  ...
  "Analyze our communication effectiveness across recent training events": `Analysis of communication effectiveness across 37 training events reveals several key patterns:
...
Recent trend analysis shows marginal improvement in communication under stress (12% better than previous quarter), but significant room for further enhancement remains.`,
  ...
  "What training areas show the most improvement over the last 3 months?": `Based on comparative analysis of AARs from the last 3 months against the previous quarter, these training areas show the most significant improvement:
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-muted-foreground">
              Ask specific questions about your training data and get tailored
              insights
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="md:col-span-2 space-y-4">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4 prompt-input">
                  {" "}
                ...
                <div className="space-y-2">
                  {examplePrompts.map((example, index) => (
                    <Button
                      key={index}
                      variant={
                        selectedExample === example ? "default" : "outline"
                      }
              ...
              <CardContent>
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="item-1">
                    ...
                    <AccordionContent>
                      You can ask any question related to your unit's training
                      performance, patterns in AARs, comparative analysis
                      between units or time periods, and specific insights about
                      training categories.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-2">
                    ...
                    <AccordionContent>
                      GreenBookAAR analyzes all accessible AAR data, training
                      events, and historical performance metrics. It uses
                      advanced natural language processing to understand your
                      specific question and generates insights based on patterns
                      in your data.
                    </AccordionContent>
                  </AccordionItem>
                  <AccordionItem value="item-3">
                    ...
                    <AccordionContent>
                      Any user can analyze data they have access to. Unit
                      leaders can analyze data from their unit and subordinate
                      units, while individual soldiers can analyze their
                      personal training history and units they've been assigned
                      to.
                    </AccordionContent>
                  </AccordionItem>
                </Accordion>
