    ...
    <div className="container py-6">
      ...
      <div className="flex flex-col space-y-6">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl font-bold tracking-tight">Ready to Transform Your Training?</h1>
          <p className="text-xl text-muted-foreground mt-4">
            Start using GreenBookAAR to enhance your unit's training effectiveness, preserve
            institutional knowledge, and drive continuous improvement.
          </p>
        </div>
        
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          <Card className={`border-2 ${selectedPlan === "platoon" ? "border-primary" : "border-border"}`}>
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <FeatureItem icon={<Building className="h-4 w-4" />} text="Up to 50 personnel" />
                <FeatureItem icon={<Calendar className="h-4 w-4" />} text="Unlimited training events" />
                <FeatureItem icon={<FileText className="h-4 w-4" />} text="Unlimited AARs" />
                <FeatureItem icon={<BarChart3 className="h-4 w-4" />} text="Basic AI analysis" />
                <FeatureItem icon={<Shield className="h-4 w-4" />} text="Standard user roles" />
              </div>
            </CardContent>
          </Card>
          
          <Card className={`border-2 ${selectedPlan === "company" ? "border-primary" : "border-border"}`}>
            <CardHeader>
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <div className="text-3xl font-bold mt-2">$249<span className="text-base font-normal text-muted-foreground">/month</span></div>
                </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <FeatureItem icon={<Building className="h-4 w-4" />} text="Up to 200 personnel" />
                <FeatureItem icon={<Calendar className="h-4 w-4" />} text="Unlimited training events" />
                <FeatureItem icon={<FileText className="h-4 w-4" />} text="Unlimited AARs" />
                <FeatureItem icon={<BarChart3 className="h-4 w-4" />} text="Advanced AI analysis" />
                <FeatureItem icon={<Sparkles className="h-4 w-4" />} text="Custom AI queries" />
                <FeatureItem icon={<Shield className="h-4 w-4" />} text="Enhanced user roles" />
              </div>
            </CardContent>
          </Card>
          
          <Card className={`border-2 ${selectedPlan === "battalion" ? "border-primary" : "border-border"}`}>
            <CardHeader>
              <CardTitle>Battalion Level</CardTitle>
              <CardDescription>
                For battalions requiring enterprise-level capabilities
              </CardDescription>
              <div className="text-3xl font-bold mt-2">$599<span className="text-base font-normal text-muted-foreground">/month</span></div>
            </CardHeader>
            <CardContent className="space-y-4">
              <Button 
              ...
              <div className="space-y-2">
                <FeatureItem icon={<Building className="h-4 w-4" />} text="Unlimited personnel" />
                <FeatureItem icon={<Calendar className="h-4 w-4" />} text="Unlimited training events" />
                <FeatureItem icon={<FileText className="h-4 w-4" />} text="Unlimited AARs" />
                <FeatureItem icon={<BarChart3 className="h-4 w-4" />} text="Enterprise AI analysis" />
                <FeatureItem icon={<Sparkles className="h-4 w-4" />} text="Advanced custom queries" />
                <FeatureItem icon={<Shield className="h-4 w-4" />} text="Complete access controls" />
                <FeatureItem icon={<Building className="h-4 w-4" />} text="Multi-battalion support" />
              </div>
            </CardContent>
          </Card>
        </div>
