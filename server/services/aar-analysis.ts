...
export class AARAnalysisService {
  ...
  private analyzeIssues(improveItems: AARItemType[]) {
    ...
    const keywordMap = this.groupItemsByKeywords(improveItems, [
      ...
      {
        category: "Training Deficiencies",
        keywords: [
          "training",
          "drill",
          "rehearsal",
  ...
  private generateRecommendations(
    actionItems: AARItemType[],
    improveItems: AARItemType[]
  ) {
   ...
   */
  private groupItemsByKeywords(
    items: AARItemType[],
    categoryKeywords: { category: string; keywords: string[] }[]
  ) {
  ...
  private generateRecommendationDescription(
    ...
    switch (category) {
      case "Communications Training":
        description =
          "Implement weekly radio check procedures and standardize communications protocols across all units.";
        break;
      case "Planning Improvement":
        description =
          "Institute a standardized planning timeline with specific checkpoints for OPORDER development, rehearsals, and PCCs/PCIs.";
        break;
      case "Tactical Execution":
        description =
          "Conduct quarterly tactical exercises focusing specifically on maneuver techniques and battle drills.";
        break;
      case "Leadership Development":
        description =
          "Establish monthly leadership professional development sessions with practical decision-making scenarios.";
        break;
      case "Equipment Maintenance":
        description =
          "Implement weekly equipment maintenance checks with detailed accountability procedures and preventative maintenance training.";
        break;
      case "Training Programs":
        description =
          "Develop progressive training programs that build fundamental skills before advancing to complex scenarios and exercises.";
        break;
      default:
        description =
          phrases.length > 0
  ...
  private extractKeyPhrases(items: AARItemType[], count: number): string[] {
    ...
    for (let i = 0; i < maxTries && selectedSentences.length < count; i++) {
      ...
      if (
        sentence.length > 10 &&
        sentence.length < 100 &&
        !selectedSentences.includes(sentence)
      ) {
    ...
    return [
      {
        ...
        description:
          "Consistent use of proper radio procedures during operations enhances command and control effectiveness. Units demonstrate strong adherence to communication SOPs.",
        frequency: 7,
        severity: "Medium",
      },
      {
        ...
        description:
          "Detailed mission planning and thorough briefings contribute to operational success. Units consistently developing comprehensive OPORDs show improved execution.",
        frequency: 5,
        severity: "Medium",
      },
      {
        ...
        description:
          "Effective small-unit tactics and team movement techniques observed across multiple exercises. Squads demonstrate strong mutual support during operations.",
        frequency: 6,
        severity: "Medium",
      },
    ];
    ...
    return [
      {
        ...
        description:
          "Radio discipline breaks down during high-stress phases of operations. Units frequently revert to non-standard terminology when under pressure.",
        impact: "High",
      },
      {
        category: "Equipment Readiness",
        description:
          "Pre-combat inspections fail to identify common equipment issues, particularly with night vision devices and communication equipment.",
        impact: "Medium",
      },
    ];
  }
    ...
    return [
      {
        category: "Communications Training",
        description:
          "Implement weekly communications exercises with progressive complexity. Start with basic radio procedures and advance to degraded communications scenarios requiring alternate methods.",
        priority: "High",
      },
      {
        category: "Equipment Maintenance",
        description:
          "Establish mandatory pre-mission and post-mission maintenance checks for all critical equipment. Create detailed inspection checklists specific to each equipment type.",
        priority: "Medium",
      },
      {
        category: "Leader Development",
        description:
          "Conduct monthly leader certification exercises focused on decision-making under stress. Include scenarios requiring adaptation to changing mission parameters.",
        priority: "Medium",
      },
    ];
  }
