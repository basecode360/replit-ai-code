import { User, Unit, MilitaryRoles, UnitLevels, MilitaryHierarchy } from "@shared/schema";
 ...
 */
export async function canUserAccessUnit(user: User, targetUnit: Unit): Promise<boolean> {
 ...
 */
async function isUnitInChainOfCommand(sourceUnit: Unit, targetUnit: Unit): Promise<boolean> {
